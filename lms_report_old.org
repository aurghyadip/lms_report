...
** TASKS                                                           :noexport:
*** DONE Re-format document [44/44]
    CLOSED: [2018-05-03 Thu 17:27] SCHEDULED: <2018-04-26 Thu>
    - [X] Add Abstract
    - [X] Add literature survey
    - [X] Add introduction
    - [X] Add Requirements[1/1]
      - [X] Specific Requirements[0/0]
	- [X] Hardware Requirements
	- [X] Software Requiements
	- [X] Communication Interfaces
    - [X] Functional Requirements[0/0]
	- [X] The Borrower
	- [X] The Librarian
	- [X] The Administrator
    - [X] Performance Requirements[0/0]
	- [X] Speed and Latency Requirements
	- +Precision or Accuracy Requirements+
	- [X] Capacity Requirements
    - [X] Dependability Requiremnents[0/0]
	- [X] Reliability
	- +Availability+
	- [X] Robustness or Fault-Tolerance
    - [X] Maintainability and Supportability Requirements[0/0]
	- [X] Maintainability
	- [X] Supportability
	- +Adaptability+
	- [X] Scalability
    - [X] Security Requirements[0/0]
	- [X] Access
	- [X] Integrity
	- [X] Privacy
...
*** DONE Merge with the current project report
    CLOSED: [2018-05-03 Thu 17:27] SCHEDULED: <2018-05-02 Mon>
