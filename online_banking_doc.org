...
[[./diagrams/UseCaseBank.jpg]]

* CONCLUSION
To conclude the srs
Online Banking System helps to manage the daily activiites of the 
bank with more effecient way for transactions and related queries. 
Which  saves everyday's time and effort for everyone .Further with the evolving
technologies this banking system can  further  be created for 
phones , tablets for easy usage. 
